...
void IMUupdate(float half_T, float gx, float gy, float gz, float ax, float ay, float az, float *rol, float *pit, float *yaw)
{
    ...
    //ref_q[0]*ref_q[0] - ref_q[1]*ref_q[1] - ref_q[2]*ref_q[2] + ref_q[3]*ref_q[3];
    ...
    ref.g.z = (gz - Kp *(1.5f) *To_180_degrees(yaw_mag - Yaw))*ANGLE_TO_RADIAN;//+ ( Kp*(ref.err.z + ref.err_Int.z) )  ;   //IN RADIAN
