...
sPID_TypeDef G_PID_Parameter = {
	...
	/*位置环y*/
	{{ 5,0,0,800,-800,800,0,30,20 }  
	,{0,0,0,0,0}
	},
	/*位置环x*/
	{{ 5,0,0,700,-700,650,0,30,20 }  
	,{0,0,0,0,0}
	}
};
//#define SPEED_L 
